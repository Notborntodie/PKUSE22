...
void DeleteMaxMin(LinkList& L, int max, int min); //作业第五题
void ReturnMaxNode(LinkList& L);//作业第四题
void ReverseList(LinkList& L);//作业第三题
void ConcatTwoList(LinkList& L1, LinkList& L2);//作业第一，二题
...
int main()
{
	...
	int h2n1 = 12, h2n2 = 11;
	printf("第一个随机生成的链表为：\n");
	GenerateNode(h21, h2n1);
	printf("\n");
	printf("第二个随机生成的链表为：\n");
	GenerateNode(h22, h2n2);
	printf("\n");
	Sort(h21, h2n1);
	Sort(h22, h2n2);
	ConcatTwoList(h21, h22);
	ReverseList(h21);
	printf("\n/*********************作业第二题***********************/\n\n");
